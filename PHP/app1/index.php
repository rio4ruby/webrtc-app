    ...
    <div class="container">
      ...
      <div class="row inline-row">
        <div class="col-lg-12">
          ...
          <div class="col-sm-2">
            <a class="btn btn-block btn-warning" target="_blank" href="<?php echo $linkSource; ?>">Source</a>
          </div>
          <div class="col-sm-2">
            <a class="btn btn-block btn-warning" target="_blank" href="<?php echo $linkDownload; ?>">Download</a>
          </div>
          <div class="col-sm-4"></div>
        </div>
      </div><!--./inline-row-->
          ...
          <div class="col-sm-10">
            <ol>
              ...
              <li>
                ...
                out the 
                <a href="<?php echo $githubServerLink; ?>" target="_blank">Server</a>
                and how it interacts with the 
                <a href="<?php echo $githubClientLink; ?>" target="_blank">Client side SDK</a>
              </li>
            </ol>
          </div>
        </div>
                      ...
                      <div id="mobileAssociate" >
                        <div class="col-lg-12">
                          ...
                          <div class="col-lg-4">
                            ...
                            <input id="auth_code" name="auth_code" placeholder="Authorization code" class="form-control" type="text" <?php if (isset($_GET['code'])) { echo 'value="' . $_GET['code'] . '"'; } ?>>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-5 form-group">
                            <select id="vtnNumber" class="form-control">
                              <?php foreach ($vtns as $vtn) { ?>  
                                <option>vtn:<?php echo $vtn; ?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
